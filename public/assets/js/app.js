...
function validateForm() {
  ...
  if (name == '' || name == null) {
    document.getElementById('error-msg').innerHTML =
      "<div class='p-3 text-center mb-4 text-sm text-orange-700 bg-orange-100 rounded error_message'>Please enter a Name</div>";
    fadeIn();
    return false;
  }
  if (email == '' || email == null) {
    document.getElementById('error-msg').innerHTML =
      "<div class='p-3 text-center mb-4 text-sm text-orange-700 bg-orange-100 rounded error_message'>Please enter a Email</div>";
    fadeIn();
    return false;
  }
  if (subject == '' || subject == null) {
    document.getElementById('error-msg').innerHTML =
      "<div class='p-3 text-center mb-4 text-sm text-orange-700 bg-orange-100 rounded error_message'>Please enter a Subject</div>";
    fadeIn();
    return false;
  }
  if (comments == '' || comments == null) {
    document.getElementById('error-msg').innerHTML =
      "<div class='p-3 text-center mb-4 text-sm text-orange-700 bg-orange-100 rounded error_message'>Please enter a Comments</div>";
    fadeIn();
    return false;
  }
